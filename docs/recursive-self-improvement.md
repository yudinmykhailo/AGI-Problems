...
**Category:** Systemic / Technical  
**Problem status:** Theoretical / Initial stages

---
## The essence of the problem

The ability of AI to analyze, rewrite, and optimize its own source code and architecture. In theory, this leads to a cycle where each improvement accelerates the creation of the next, even more efficient improvement.
...
- **Eliezer Yudkowsky** - analysis of goal stability under self-modification.